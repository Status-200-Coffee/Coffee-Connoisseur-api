module.exports = [
  {
    ...
    {
      image:
        "https://www.sage.com/en-gb/blog/wp-content/uploads/sites/10/2021/03/coffee-shop-1209863_1920-1.jpg",
      altText:
        "Coffee shop with white brick walls and counter with coffee machines, man making coffee in background.",
    },
    userImages: [
  ...
  },
  {
    ...
    mainImage: {
      ...
      altText:
        "Large black sign with 'COFFEE' written on it, two stools in front of a small counter with a person in the background.",
    },
    userImages: [
  ...
  },
  {
    ...
    {
      image:
        "https://hips.hearstapps.com/hmg-prod/images/coffee-shop-interior-stock-photo-royalty-free-image-1683659841.jpg?crop=0.88847xw:1xh;center,top&resize=1200:*",
      altText:
        "Mustard colour sofa with tables and chairs in foreground, yellow, pink and black canvas on the far wall.",
    },
    userImages: [
  ...
  },
  {
    ...
    {
      image:
        "https://i.pinimg.com/236x/99/e5/39/99e5398ba3922b11c2112ce06954b298.jpg",
      altText:
        "Tiled white coffee counter with plants and magazine rack in front.",
    },
    userImages: [
  ...
  },
  {
    ...
    {
      image:
        "https://impeccabuild.com.au/wp-content/uploads/2020/07/Coffee-Shop-Lighting-Tips-ImpeccaBuild-5-scaled.jpg",
      altText:
        "Large open-plan restaurant with wall of windows and wooden counter.",
    },
    userImages: [
  ...
  },
  {
    ...
    {
      image:
        "https://impeccabuild.com.au/wp-content/uploads/2020/08/Cafe-Theme-Ideas-Cafe-Fitout-ImpeccaBuild-12-scaled.jpg",
      altText:
        "Cafe interior with modern industrial styling, dark wood tables, dark ceiling and floor to ceiling window wall.",
    },
    userImages: [
      "https://www.foodandwine.com/thmb/FvbOWRmQTfXCCdWPuHJ_DuVSy5Q=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/how-to-order-coffee-ft-blog0517-5955af2ce9474cf6b291dc7c98cd6667.jpg",
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRo_l-KRm_DMBRZfXWV5ngZn9n9yCKeR-8raejmuan5wKZOODM5YvZ3MaD6KoyRFHUBkxQ&usqp=CAU",
      "https://www.acouplecooks.com/wp-content/uploads/2020/09/Latte-Art-066s.jpg",
      "https://esquirescoffee.co.uk/wp-content/uploads/2021/02/A-hand-picking-up-an-americano.jpg",
    ],
    latitude: 54.8998,
    longitude: -2.9183,
    city: "Carlisle",
  ...
  },
  {
    ...
    {
      image:
        "https://dev.muddystilettos.co.uk/norfolk/wp-content/uploads/sites/12/2023/09/The-Old-Store.jpg",
      altText:
        "Coffee counter with yellow wood panelling and glass baked goods case on top, man in background using coffee machine.",
    },
    userImages: [
      ...
      "https://www.berlyskitchen.com/wp-content/uploads/2023/08/Coffee-with-Kahlua-Featured-Image.jpg",
      "https://www.tasteofhome.com/wp-content/uploads/2023/02/TOH-coffee-vs-espresso-GettyImages-1413384122-JVedit.jpg",
    ],
    latitude: 54.8987,
    longitude: -2.9476,
    city: "Carlisle",
  ...
  },
  {
    ...
    mainImage:
    {
      ...
      altText:
        "Coffee counter with coffee machine and three stools, grey wall with shelving in the background.",
    },
    userImages: [
  ...
  },
  {
    ...
    mainImage:
    {
      ...
      altText:
        "Wooden coffee counter with coffee machines and menu on a blackboard on the wall behind.",
    },
    userImages: [
  ...
  },
  {
    ...
    {
      image:
        "https://staging.hartmillerdesign.co.uk/wp-content/uploads/2021/06/coffee-shop-interiors_origin_shop-1024x739-1.jpg",
      altText:
        "Bright coffee shop with a wall of windows, bench seating and tables.",
    },
    userImages: [
    ...
    dairyFree: true,
    hasSeating: false,
    description: "Your go-to spot for coffee bliss."
  },
];
